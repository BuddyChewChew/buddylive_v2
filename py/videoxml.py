...
channel_names = {
    ...
    "stadium-wlnytv3-riverhead-ny/34537": "Charge!",
    ...
    "ctv2-toronto-on/36": "CTV2 Toronto",
    ...
    "history-2-canada/461": "History 2",
    "history-canada-east/164": "History Canada",
...
if all_programs:
    ...
    for channel_id in channel_names_list:
        if channel_id in all_programs:  # Check if channel exists in all_programs
            ...
            print(f"Warning: No program data found for channel {channel_id} - {channel_names.get(channel_id, 'Unknown')}")
            channel_programs[channel_id] = []  # Initialize with empty list if no data
